...
This checklist is for human verification before publishing SuwolView 0.2.2.
...
- [ ] v0.2.2 release page exists
- [ ] Windows setup.exe is uploaded
- [ ] Windows ZIP is uploaded
- [ ] macOS DMG is uploaded
- [ ] macOS ZIP is uploaded
...
- [ ] App opens folder
- [ ] App drag/drop works
- [ ] Fullscreen shortcut or native fullscreen equivalent works
- [ ] Update check does not crash
- [ ] App is signed
- [ ] App is notarized/stapled if notarization is enabled
